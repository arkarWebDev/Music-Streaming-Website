<template>
  <section class="bg-white h-screen flex justify-ceenter">
    <div class="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
      ...
      <div class="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
        <h2 class="text-5xl font-semibold tracking-tight text-gray-800 xl:text-4xl">
          Download our free mobile app
        </h2>

        <p class="block max-w-2xl mt-4 text-gray-500 text-center xl:text-left">
        ...
        <div class="mt-6 sm:-mx-2">
          <a
            href="#"
            class="inline-flex items-center justify-center w-full px-5 py-3 overflow-hidden text-purple-600 transition-colors border border-purple-600 duration-300 rounded-lg shadow sm:w-auto sm:mx-2 focus:ring focus:ring-gray-300 focus:ring-opacity-80"
          >
            <svg
          ...
          <a
            href="#"
            class="inline-flex items-center justify-center w-full px-5 py-3 mt-4 overflow-hidden text-white transition-colors duration-300 bg-purple-600 rounded-lg shadow sm:w-auto sm:mx-2 sm:mt-0 focus:ring focus:ring-blue-300 focus:ring-opacity-80"
          >
            <svg
              class="w-5 h-5 mx-2 fill-current"
