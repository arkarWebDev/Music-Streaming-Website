<template>
  ...
  <section class="w-full mb-8 py-14 text-center text-white relative">
    ...
    <div class="container mx-auto flex items-center">
      ...
      <button
        type="button"
        class="z-50 h-24 w-24 text-3xl text-purple-600 border-4 border-purple-600 rounded-full focus:outline-none"
      >
  ...
  <section class="container mx-auto mt-6">
    <div class="bg-white rounded border border-gray-200 relative flex flex-col">
      ...
      <div class="p-6">
        ...
        <vee-form :validation-schema="schema" @submit="submitComment" v-if="userIsLogin">
          <vee-field
            as="textarea"
            name="comment"
